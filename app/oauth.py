...
GOOGLE_REDIRECT_URI = os.getenv(
    "GOOGLE_REDIRECT_URI", "http://spotifymvpclone-production.up.railway.app/api/auth/google/callback"
)
...
GITHUB_REDIRECT_URI = os.getenv(
    "GITHUB_REDIRECT_URI", "http://spotifymvpclone-production.up.railway.app/api/auth/github/callback"
)
