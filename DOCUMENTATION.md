...
- **Поиск** — по трекам, альбомам и артистам в реальном времени
- **Your Library** — плейлисты пользователя
...
| Метод | Путь | Описание |
|-------|------|---------|
| GET | `/?q=запрос` | Поиск по трекам, альбомам, артистам |
...
| Home | `/` | MainLayout | Главная с featured/trending треками |
| Search | `/search` | MainLayout | Поиск |
| Library | `/library` | MainLayout | Плейлисты пользователя |
| Album | `/albums/:id` | MainLayout | Страница альбома |
...
### 13.03.2026 — Исправление критических багов
...
*Документация актуальна на 13.03.2026*
